-- Restaura transactions_view completa:
-- a migration 20260507000001 (tax engine) recriou a view sem tenant_name.
-- Esta migration reconcilia: mantém withheld_irrf e restaura tenant_name.
