          ...
          <div className="glass-panel" style={{ width: '100%', maxWidth: '540px', background: 'rgba(25,28,38,0.97)', padding: '36px', position: 'relative', borderRadius: '24px', boxShadow: '0 30px 60px rgba(0,0,0,1)', border: '1px solid rgba(255,255,255,0.1)', maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            <form action={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr', gap: '16px', alignItems: 'start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <div>
                    ...
                    <select name="type" required style={{ ...inp, appearance: 'auto', padding: '10px 14px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 80px', gap: '10px' }}>
                    ...
                    <div>
                      ...
                      <input name="street_number" placeholder="402" style={inp} />
                    </div>
                  </div>
              ...
              <div>
                ...
                <textarea name="notes" rows={1} placeholder="Características especiais, reformas..." style={{ ...inp, resize: 'vertical', fontFamily: 'inherit' }} />
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '4px' }}>
                <button type="button" onClick={() => { setIsOpen(false); reset() }} disabled={isLoading} style={{ padding: '8px 16px', borderRadius: '10px', background: 'transparent', border: 'none', color: 'var(--text-secondary)', cursor: 'pointer', fontSize: '13px' }}>
                  Cancelar
                </button>
